...
*すべての*ピクセルに独立してクラスを割り当てるため、モデルは複雑な物体の形状を正確に縁取ることができます。
...
[Image explaining Intersection over Union (IoU) metric with overlapping areas]
...
def generate_iou_figure():
    ...
    print("Saved 'iou_diagram.png' successfully.")
    plt.close()
```
